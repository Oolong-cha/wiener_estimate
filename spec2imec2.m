...
%----------------------------------------------------------------------
%IMECカメラ分光感度読み込み
imec601=csvread('../data/imec_spectralsensitivity_400to1000_1nm.csv');
imec77=imec601(1:5:381,2:17)';
hokanzero=zeros(16,4);
imec81=horzcat(hokanzero,imec77);
%--------------------------------------------------------------------
...
%-------------------
imshow(reshape(gxyz_srgb,height,width,3));
